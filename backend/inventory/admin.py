...
class CategoryAdmin(SimpleHistoryAdmin): # CHANGED from admin.ModelAdmin
...
class SupplierAdmin(SimpleHistoryAdmin): # CHANGED from admin.ModelAdmin
...
class ProductAdmin(SimpleHistoryAdmin): # CHANGED from admin.ModelAdmin
...
class InventoryMovementAdmin(admin.ModelAdmin):
    # InventoryMovement is already a log table, so this remains admin.ModelAdmin
...
class LowStockAlertAdmin(SimpleHistoryAdmin): # CHANGED from admin.ModelAdmin
