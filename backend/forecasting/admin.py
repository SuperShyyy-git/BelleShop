...
class ForecastModelAdmin(SimpleHistoryAdmin): # CHANGED
...
class ProductForecastAdmin(SimpleHistoryAdmin): # CHANGED
...
class CategoryForecastAdmin(SimpleHistoryAdmin): # CHANGED
...
class SeasonalPatternAdmin(SimpleHistoryAdmin): # CHANGED
...
class StockRecommendationAdmin(SimpleHistoryAdmin): # CHANGED
